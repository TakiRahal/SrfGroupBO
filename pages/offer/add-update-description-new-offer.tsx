...
import {addDescriptionNewOffer, addSuccessDescriptionNewOffer, entitiesDescriptionNewOffer, resetDescriptionNewOffer} from "../../src/store/offer/slice";
...
export default function AddUpdateDescriptionNewOffer(){
    ...
    const addSuccessDescriptionNewOfferSelector = useSelector(addSuccessDescriptionNewOffer) ?? false;
