...
import {entitiesDescriptionNewOffer, fetchDescriptionNewOffer} from "../../src/store/offer/slice";
...
export default function DescriptionNewOffer(){
    ...
    const entitiesDescriptionNewOfferSelector = useSelector(entitiesDescriptionNewOffer) ?? [];
            ...
            <main className="container-main">
                <div>
                    ...
                    <table className="border-collapse border border-slate-400 w-full">
                        ...
                        {
                            entitiesDescriptionNewOfferSelector.map((description: any, i: number) => (
