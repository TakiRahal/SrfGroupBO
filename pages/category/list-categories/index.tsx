...
import {
    entitiesCategories,
    fetchCategories,
    loadingEntitiesCategories,
    resetCategories,
    importCategories,
    importSuccessCategories
} from "../../../src/store/category/slice";
...
export default function ListCategories(){
    ...
    const importSuccessCategoriesSelector = useSelector(importSuccessCategories) ?? false;
            ...
            <main className="container-main">
                <div className="card">
                    <div className="flex">
                        ...
                        <div className="">
                            <Button label="Import " className="p-button-success" icon="pi pi-check" onClick={() => importActionCategories()}/>
