...
import {initialValuesPostHomeFeature, validationSchemaPostHomeFeature} from "../../../lib/home/validation/validation-home";
import {dataUrlToFile, getBase64} from "../../../lib/utils-functions";
import {isEmpty} from "fast-glob/out/utils/string";
import {useDispatch, useSelector} from "react-redux";
import {addFeatureHome, addSuccessFeatureHome, entitiesFeatureHome, entityFeatureHome, fetchFeatureHome, resetFeatureHome} from "../../../src/store/home/slice";
...
export default function AddUpdateFeatureHome(){
    ...
    const addSuccessFeatureHomeSelector = useSelector(addSuccessFeatureHome) ?? false;
    ...
    React.useEffect(() => {
        if(!isEmpty(entityFeatureHomeSelector)){
            ...
            formik.setFieldValue('descriptionAr', entityFeatureHomeSelector.descriptionAr);
            formik.setFieldValue('descriptionFr', entityFeatureHomeSelector.descriptionFr);
            formik.setFieldValue('descriptionEn', entityFeatureHomeSelector.descriptionEn);
                        ...
                        <tr>
                            <td className="border border-slate-300 ...">
                                <div className="p-5 text-gray-700">
                                    ...
                                    <CustomSunEditor defaultValue={entityFeatureHomeSelector.descriptionAr || ''} callbcakHandleChange={onEditorStateChangeAr}/>
                            ...
                            <td className="border border-slate-300 ...">
                                <div className="p-5 text-gray-700">
                                    ...
                                    <CustomSunEditor defaultValue={entityFeatureHomeSelector.descriptionFr || ''} callbcakHandleChange={onEditorStateChangeFr}/>
                            ...
                            <td className="border border-slate-300 ...">
                                <div className="p-5 text-gray-700">
                                    ...
                                    <CustomSunEditor defaultValue={entityFeatureHomeSelector.descriptionEn || ''} callbcakHandleChange={onEditorStateChangeEn}/>
