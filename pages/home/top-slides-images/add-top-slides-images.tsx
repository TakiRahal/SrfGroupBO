...
import {initialValuesTopHomeSlidesImage, validationSchemaTopHomeSlidesImage} from "../../../lib/home/validation/validation-home";
import {isEmpty} from "fast-glob/out/utils/string";
import {useDispatch, useSelector} from "react-redux";
import {addSuccessTopSlides, addTopSlides, entitiesTopSlides, entityTopSlides, resetTopSlides} from "../../../src/store/home/slice";
...
export default function AddUpdateTopSlidesImages(){
    ...
    React.useEffect(() => {
        if(!isEmpty(entityTopSlidesSelector)){
            ...
            formik.setFieldValue('descriptionAr', entityTopSlidesSelector.descriptionAr);
            formik.setFieldValue('descriptionFr', entityTopSlidesSelector.descriptionFr);
            formik.setFieldValue('descriptionEn', entityTopSlidesSelector.descriptionEn);
                        ...
                        <tr>
                            <td className="border border-slate-300 ...">
                                <div className="p-5 text-gray-700">
                                    ...
                                    <CustomSunEditor defaultValue={entityTopSlidesSelector.descriptionAr || ''} callbcakHandleChange={onEditorStateChangeAr}/>
                            ...
                            <td className="border border-slate-300 ...">
                                <div className="p-5 text-gray-700">
                                    ...
                                    <CustomSunEditor defaultValue={entityTopSlidesSelector.descriptionFr || ''} callbcakHandleChange={onEditorStateChangeFr}/>
                            ...
                            <td className="border border-slate-300 ...">
                                <div className="p-5 text-gray-700">
                                    ...
                                    <CustomSunEditor defaultValue={entityTopSlidesSelector.descriptionEn || ''} callbcakHandleChange={onEditorStateChangeEn}/>
