...
import {fetchAddressSuccess, fetchAddressFailure, importAddressSuccess, importAddressFailure } from "../slice";
...
export function* importAddressHandler(data: any): Generator<any, any, any> {
    try {
