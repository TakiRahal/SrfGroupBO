...
export const loadingUsers = (state: any) => state[USER_KEY_IN_STORE].user.loading;
export const entityUsers = (state: any) => state[USER_KEY_IN_STORE].user.entity;
export const loadingEntitiesUsers = (state: any) => state[USER_KEY_IN_STORE].user.loadingEntities;
export const entitiesUsers = (state: any) => state[USER_KEY_IN_STORE].user.entities;
export const totalItemsUsers = (state: any) => state[USER_KEY_IN_STORE].user.totalItems;
export const totalPagesUsers = (state: any) => state[USER_KEY_IN_STORE].user.totalPages;
