...
export const loadingEntitiesDeclarationProblem = (state: any) => state[DECLARATION_PROBLEM_KEY_IN_STORE].declarationProblem.loadingEntities;
export const entitiesDeclarationProblem = (state: any) => state[DECLARATION_PROBLEM_KEY_IN_STORE].declarationProblem.entities;
export const totalItemsDeclarationProblem = (state: any) => state[DECLARATION_PROBLEM_KEY_IN_STORE].declarationProblem.totalItems;
export const totalPagesDeclarationProblem = (state: any) => state[DECLARATION_PROBLEM_KEY_IN_STORE].declarationProblem.totalPages;
