...
import {fetchDeclarationProblemFailure, fetchDeclarationProblemSuccess } from "../slice";

const apiUrl = 'api/report-probleme';

export function* fetchDeclarationProblemHandler(data: any): Generator<any, any, any> {
    try {
