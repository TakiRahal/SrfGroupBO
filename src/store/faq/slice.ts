...
export const loadingEntitiesFaq = (state: any) => state[FAQ_KEY_IN_STORE].faq.loadingEntities;
export const entitiesFaq = (state: any) => state[FAQ_KEY_IN_STORE].faq.entities;
export const totalItemsFaq = (state: any) => state[FAQ_KEY_IN_STORE].faq.totalItems;
export const totalPagesFaq = (state: any) => state[FAQ_KEY_IN_STORE].faq.totalPages;
export const addSuccessFaq = (state: any) => state[FAQ_KEY_IN_STORE].faq.addSuccess;
